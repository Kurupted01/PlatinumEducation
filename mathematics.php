...
<html>
    ...
    <title>Tutoring Sydney Maths Tutors For HSC IB University</title><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <meta name="description" CONTENT="Experienced tutoring in Sydney to maximise your ATAR. We specialize in Chemistry, Physics & Maths tutoring. Complete your year 10, 11 and 12 course easily." />
    <meta name="keywords" CONTENT="Maths Tutoring,Maths Tutor,Math Tutor" />
    <meta name="robots" content="index, follow" />
    <link rel="stylesheet" type="text/css" href="css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="style.css" />
    <link rel="stylesheet" type="text/css" href="css/customStyles.css" />
    <link rel="stylesheet" type="text/css" href="css/custom/mathematics-page.css" />
...
S</span><span class="style1">UBJECTS</span> </p>
 <div align="left">
   ...
   <p><strong><a href="mathematics.html"><img src="images/tick.jpg" border="0" alt="tick" width="16" height="17" longdesc="images/tick.jpg"></a><a href="mathematics.html" class="unnamed1 style65"> Maths</a> </strong></p>
 ...
 <div align="left">
   ...
   <p><strong><a href="mathematics.html"><img src="images/tick.jpg" border="0" alt="tick" width="16" height="17" longdesc="images/tick.jpg"></a></strong><strong><a href="primary.php" class="unnamed1 style65"> English</a></strong></p>
...
<tr>
  ...
  <td width="5%">&nbsp;</td>
	...
	<td><div align="center"> </div>
      ...
      <p align="left" style="color: #076BA7; font-size: 20px; margin-left: 0px;"><b>Maths Tutoring </b> <strong>Specialists<br>
      </strong></p>
      <p style="color: #000000; font-size: 16px; margin-left: 0px; font-style: italic;"><strong><br>
        Maths Tutors at Platinum Education</strong></p>      
      <p align="justify" class="style7">Our Maths tutors provide 100% support to students in Sydney and specialise in HSC Maths, IB Maths and all levels of University Mathss. We are very science oriented and our Maths tutors are qualified and dedicated to teaching Mathematics at the highest standard.</p>
      <h1 align="justify" class="style49">Our Maths Tutoring Service</h1>
      <p align="justify" class="style7">The tutoring service that we provide extends   beyond the classroom to help students enjoy the subjects that they study   while creating an atmosphere of enthusiastic learning and creative   thinking. This highly beneficial learning environment is achieved by   providing students with the following:</p>
      <ol>
        <li class="style1">
          <div align="left">Full year Maths courses  in accordance with the NEW Board of Studies syllabus</div>
        </li>
        <li class="style1">Following step-by-step Maths course books on every  topic</li>
        <li class="style1">
          <div align="left">Email support for students that have questions outside of Maths class times</div>
        </li>
        <li class="style1">
          <div align="left">Complementary problem solving tutorials with our Maths specialised tutors</div>
        </li>
        <li class="style1">
          <div align="left">Telephone tutor support for Maths students that require help while studying at home</div>
        </li>
        <li class="style1">
          <div align="left">Regular Maths practice topic, HSC and trial examinations covering the whole syllabus</div>
        </li>
        <li class="style1">
          <div align="left">Helping students with school work and assignments</div>
        </li>
        <li class="style1">
          <div align="left">Weekly Maths homework is given to students that is checked</div>
        </li>
        <li class="style1">
          <div align="left">Extra question time before and after Maths classes</div>
        </li>
        <li class="style1">
          <div align="left">Individual study plans for students to help them utilise their time effectively</div>
        </li>
        <li class="style1">An option of one-to-one Maths tutoring or class Maths tutoring</li>
...
<div align="center"><img src="images/hr01.gif" width="556" height="11" alt="" border="0"></div>
    ...
    <div align="center">
      ...
      <p align="justify" class="style13">&quot;<span class="style24"> from a mark of 56% to a 93% in maths, i'm very happy, thankyou for the excellent help&quot; </span><span class="style13">&nbsp;&nbsp;Emily J.</span></p>
      <p align="justify" class="style13">&quot;<span class="style24"> maths is really easy now, you have been an awsome teacher, thankyou</span>&nbsp;&quot; Alice H.</p>
      <p align="left"><span class="style13">&quot;<span class="style24"> it was hard finding a good tutor in IB maths. I understand maths much better now&quot; </span>&nbsp;Ellen W.</span></p>
...
Web CEO 4 0300/1
Code initially inserted into: "/mathematics.html".
-->
<script type="text/javascript"><!--
// hitlens v1.2.7
