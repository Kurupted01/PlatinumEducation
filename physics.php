...
<html>
    ...
    <title>Tutoring Sydney Physics Tutors For HSC IB University</title><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <meta name="description" CONTENT="Experienced tutoring in Sydney to maximise your ATAR. We specialise in Chemistry, Physics & Maths tutoring. Complete your year 10, 11 and 12 course easily" />
    <meta name="keywords" CONTENT="Tutor,Tutoring,Tutoring Sydney,Tutor Sydney,Physics Tutoring,Physics Tutor" />
    <meta name="robots" content="index, follow" />
    <link rel="stylesheet" type="text/css" href="css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="style.css" />
    <link rel="stylesheet" type="text/css" href="css/customStyles.css" />
    <link rel="stylesheet" type="text/css" href="css/custom/physics-page.css"/>
...
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-38006358-1']);
_gaq.push(['_setDomainName', 'platinumeducation.com.au']);
_gaq.push(['_trackPageview']);
...
<tr valign="bottom">
	...
	<td width="777" background="images/fon_top.gif"><table width="784" height="224" border="0" cellpadding="0" cellspacing="0" background="">
      ...
      <tr valign="bottom">
        ...
        <td width="190" rowspan="2"><img src="images/platedimage6.gif" alt="Platinum Education Tutoring" width="181" height="219"> </td>
...
S</span><span class="style1">UBJECTS</span> </p>
 <div align="left">
   ...
   <p><strong><a href="physics.html"><img src="images/tick.jpg" border="0" alt="tick" width="16" height="17" longdesc="images/tick.jpg"></a><a href="physics.html" class="unnamed1 style65"> Physics</a></strong></p>
 ...
 <div align="left">
   ...
   <p><strong><a href="physics.html"><img src="images/tick.jpg" border="0" alt="tick" width="16" height="17" longdesc="images/tick.jpg"></a> <a href="primary.php" class="unnamed1 style65"> General Ability</a></strong></p>
...
<tr>
  ...
  <td width="5%">&nbsp;</td>
	...
	<td><div align="center"> </div>
      ...
      <p align="left" style="color: #076BA7; font-size: 20px; margin-left: 0px;"><b>Physics Tutoring </b> <strong>Specialists<br>
      </strong></p>
      <p style="color: #000000; font-size: 16px; margin-left: 0px; font-style: italic;"><strong>Physics Tutors at Platinum Education</strong></p>      
      <p align="justify" class="style7">Our Physics tutors provide 100% support to students in Sydney and specialise in HSC Physics, IB Physics and all levels of University Physics. We are very science oriented and our Physics tutors are qualified and dedicated to teaching Physics at the highest standard.</p>
      <h1 align="justify" class="style49">Our Physics Tutoring Service</h1>
      <p align="justify" class="style7">The Physics tutoring service that we provide extends   beyond the classroom to help students enjoy the subjects that they study   while creating an atmosphere of enthusiastic learning and creative   thinking. This highly beneficial learning environment is achieved by   providing students with the following:</p>
      <ol>
        <li class="style1">
          <div align="left">Full year Physics courses  in accordance with the NEW Board of Studies syllabus</div>
        </li>
        <li class="style1">
          <div align="left">Full detailed Physics course notes on every core topic</div>
        </li>
        <li class="style1">
          <div align="left">Email support for students that have questions outside of Physics class times</div>
        </li>
        <li class="style1">
          <div align="left">Complementary problem solving tutorials with our Physics specialised tutors</div>
        </li>
        <li class="style1">
          <div align="left">Telephone tutor support for Physics students that require help while studying at home</div>
        </li>
        <li class="style1">
          <div align="left">Regular Physics practice topic, HSC and trial examinations covering the whole syllabus</div>
        </li>
        <li class="style1">
          <div align="left">Helping students with school work and assignments</div>
        </li>
        <li class="style1">
          <div align="left">Weekly Physics homework is given to students that is checked</div>
        </li>
        <li class="style1">
          <div align="left">Extra question time before and after Physics classes</div>
        </li>
        <li class="style1">
          <div align="left">Individual study plans for students to help them utilise their time effectively</div>
        </li>
        <li class="style1">An option of one-to-one Physics tutoring or class Physics tutoring</li>
        <li class="style1">Exam planning and maximising HSC ATAR marks and IB scores</li>
        </ol>
      <p align="justify" class="style7"><span class="style50">Platinum Education Australia is an established organisation dedicated to provide Sydney students with 100% support to be accepted into the Univeristy degree of their choice. </span></p>
      <p align="justify" class="style7"><span class="style50">Our reliable and solid academic knowledge and teaching experience ensures students are well prepared for school examinations.</span><br>
      </p>
      <div id="Header">
        <div id="HeaderInner">
          <div id="Logo"></div>
          <div id="PhonePanel"></div>
          <div></div>
        </div>
      </div>
      <!-- HEADER END -->
...
<tr>
  ...
  <td align="right" valign="top"><p align="center" class="style7 style13">
    <label><a href="index.php#testimonials" class="style29">
...
<div align="center"><img src="images/hr01.gif" width="556" height="11" alt="" border="0"></div>
    ...
    <div align="center">
      <p class="style23">&nbsp;</p>
      <p class="style23">' Highlight Testimonials ' </p>
      <p align="justify" class="style13">&quot;<span class="style24"> thankyou for al your help with physics, I was really finding it hard, but now it's good&quot; </span><span class="style13">&nbsp;&nbsp;Joy Z.</span></p>
      <p align="justify" class="style13">&quot;<span class="style24"> just wanted to say thankyou for all your great teaching. Especially in physics, it was my highest HSC mark&quot; </span>&nbsp;&nbsp;Adam T.</p>
      <p align="left"><span class="style13">&quot;<span class="style24"> tutoring at platinum education convinced me not to drop physics and I got a band 6 in it! thankyou for everything&quot; </span>&nbsp;Henry A.</span></p>
      <p align="center"><a href="contactus.php"><img src="images/atar.jpg" border="0" alt="Platinum Education Tutoring" width="159" height="129" longdesc="images/atar.jpg"></a></p>
      </div>
...
Web CEO 4 0300/1
Code initially inserted into: "/physics.html".
-->
<script type="text/javascript"><!--
// hitlens v1.2.7
